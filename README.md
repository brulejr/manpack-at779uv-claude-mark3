...
A clean-room decomposition of the single-piece reference part
`~/ham/3dprint/manpack/RT95_Manpack_rails_Dual_antenna_mount_STL.stl`
into nine separately printable modules, all of which fit a Prusa Mini
(180 × 180 mm bed). Every module-to-module joint uses stainless M4 socket-cap
bolts into brass heat-set inserts; the radio mounts on stainless M5 bolts.
